...
function Signup() {
  return (
    <div className='flex justify-center items-center w-full h-screen'>
      ...
      <form className="max-w-xl space-y-3  md:space-y-5 mx-auto">

        <img src={chatty} alt="" className='w-[80px] h-[80px] rounded-[100%]' />

        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Upload Pic</label>
